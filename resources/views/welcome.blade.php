...
<head>
    ...
    <title>Darkstar Mountain Tours</title>
    <link href="/css/app.css" rel="stylesheet">
</head>
<body>

<!-- Static navbar -->
<nav class="navbar navbar-inverse navbar-static-top  navbar-no-margin">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img src="/img/logo.png" alt="Darkstar Mountain Bike Tours"></a>
        </div>
