    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ url(Config::get('gallery.url_prefix').'photogallery') }}">Ffy photogallery</a>
            </div>
            <?php
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li {{ $albums_class }}><a href="{{ action('App\Gallery\Controllers\AlbumsController@index') }}">Albums</a></li>
                    <li {{ $photos_class }}><a href="{{ action('App\Gallery\Controllers\PhotosController@index') }}">Photos</a></li>
                </ul>
            </div>
        </div>
    </nav>
